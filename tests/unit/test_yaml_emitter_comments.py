...
class FootCommentSpacingTests(unittest.TestCase):
    ...
    def test_generated_foot_comment_before_the_next_key(self) -> None:
        ...
        self.assertEqual(render(first), 'x: "3"\n# note\n\ny: "4"\n')


class MultilineLineCommentTests(unittest.TestCase):
    def test_following_lines_go_below_at_the_key_indent(self) -> None:
        ...
        self.assertEqual(render(outer, indent=4),
                         'cat:\n    x: "3" # one\n    # two \n    # three\n    y: "4"\n')
    ...
    def test_lines_without_a_hash_get_one(self) -> None:
        ...
        self.assertEqual(render(doc), "k: v # first\n# second\n")

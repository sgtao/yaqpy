...
from yaqpy.core.engine.helpers import match_key
from yaqpy.core.engine.navigator import Navigator
from yaqpy.core.lang.ast import ExprNode, Operation
from yaqpy.core.lang.prefs import RecursiveDescentPrefs, TraversePrefs
...
def traverse_array_operator(nav: Navigator, ctx: Context, expr: ExprNode) -> Context:
    if (expr.rhs is not None and expr.rhs.rhs is not None
        ...
        from yaqpy.core.operators.slice import slice_array_operator
